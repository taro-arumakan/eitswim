...
<ul>
<li>
<p class="f09em"><?php echo __( '* Will create the back up for all the Supreme customized data.', 'luxeritas' ); ?></p>
...
<ul>
<li>
<p class="f09em"><?php echo __( '* Will restore Supreme customized setting from JSON backed up file.', 'luxeritas' ); ?></p>
