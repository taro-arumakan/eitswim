...
?>
  ...
  <section id="page-content" class="p-b-0">
    <div class="container">
      <!-- Portfolio -->
      <div id="portfolio" class="grid-layout portfolio-5-columns" data-lightbox="gallery" data-margin="5">
        ...
        foreach( $posts as $post ):
          ...
          <div class="portfolio-item img-zoom pf-illustrations pf-uielements pf-media">
            <div class="portfolio-item-wrap">
              <div class="portfolio-image"> <a href="#"><img src="<?php echo $image;?>" alt=""></a> </div>
