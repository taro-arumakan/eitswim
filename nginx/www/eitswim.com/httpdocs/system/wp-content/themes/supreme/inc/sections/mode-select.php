...
<p class="radio">
<input type="radio" disabled value="bootstrap4" name="luxe_mode_select"<?php thk_value_check( 'luxe_mode_select', 'radio', 'bootstrap4' ); ?> />
<span style="opacity:.6">Bootstrap 4 Mode (Coming soon. Please wait for the release of bootstrap 4 official version.)</span>
</p>
</li>
</ul>
