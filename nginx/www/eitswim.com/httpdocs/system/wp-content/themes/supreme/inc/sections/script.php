...
<ul>
<li>
<p class="control-title"><?php printf( __( 'Combine jQuery and other scripts', 'luxeritas' ), 'Meta keywords ' ); ?></p>
<p class="radio">
<input type="radio" value="not" name="jquery_migrate"<?php thk_value_check( 'jquery_migrate', 'radio', 'not' ); ?> />
<?php echo __( 'Don\'t combine', 'luxeritas' ) ?>
</p>
<p class="radio">
<input type="radio" value="migrate" name="jquery_migrate"<?php thk_value_check( 'jquery_migrate', 'radio', 'migrate' ); ?> />
<?php echo __( 'Combine jQuery and jQuery-migrate', 'luxeritas' ), ' ( ' . __( 'speed boost', 'luxeritas' ) . ' )' ?>
</p>
<p class="radio">
<input type="radio" value="luxeritas" name="jquery_migrate"<?php thk_value_check( 'jquery_migrate', 'radio', 'luxeritas' ); ?> />
<?php echo __( 'Combine jQuery and jQuery-migrate and Luxeritas\'s script', 'luxeritas' ), ' ( ' . __( 'further speed boost', 'luxeritas' ) . ' )' ?>
</p>
</li>
<li>
