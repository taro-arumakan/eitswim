...
add_action( 'customize_register', function( $wp_customize ) {
  ...
  // トップページ
  //---------------------------------------------------------------------------
  if($wp_customize->get_section( 'top_page_section')===false):
  $wp_customize->add_section( 'top_page_section', array(
    'title'		=> __( 'Top page setting', 'luxeritas' ),
    'description'	=> '<p class="bold f11em mm15b">' . __( 'Top page setting', 'luxeritas' ) . '</p>',
    'priority'	=> 27
  ) );
  //NEWSタイトル	text
  $wp_customize->add_setting( 'elc_top_page_news_title', array(
    'default'	=> 'News &amp; Press',
    'type'      => 'option',
    'sanitize_callback' => 'thk_sanitize'
  ) );
  $wp_customize->add_control( 'elc_top_page_news_title', array(
    'settings'	=> 'elc_top_page_news_title',
    'label'		=> __( 'News Title', 'luxeritas' ),
  ...
  //NEWS表示件数	number
  $wp_customize->add_setting( 'elc_top_page_news_count', array(
    'default'	=> 5,
    'type'      => 'option',
    //'transport' => 'postMessage',
    'sanitize_callback' => 'thk_sanitize_integer'
  ) );
  $wp_customize->add_control( 'elc_top_page_news_count', array(
    'settings'	=> 'elc_top_page_news_count',
    'description'	=> '<p class="m0t">' . __( 'News count', 'luxeritas' ) . '</p>',
    'section'	=> 'top_page_section',
    'type'		=> 'number',
    'priority'	=> 20
  ) );
  //NEWマークの表示期間	number
  $wp_customize->add_setting( 'elc_top_page_news_term', array(
    'default'	=> 14,
    'type'      => 'option',
    //'transport' => 'postMessage',
    'sanitize_callback' => 'thk_sanitize_integer'
  ) );
  $wp_customize->add_control( 'elc_top_page_news_term', array(
    'settings'	=> 'elc_top_page_news_term',
    'description'	=> '<p class="m0t">' . __( 'News mark display term', 'luxeritas' ) . '</p>',
    'section'	=> 'top_page_section',
    'type'		=> 'number',
    'priority'	=> 30
  ) );
  ...
  $wp_customize->add_control( 'elc_top_page_google_url', array(
    ...
    'label'		=> __( 'Footer Google+ URL', 'luxeritas' ),
    'description'	=> '<p class="f09em">' . __( '', 'luxeritas' ) . '</p>',
    'section'	=> 'top_page_section',
    'type'		=> 'text',
    'priority'	=> 100
  ) );
  ...
  $wp_customize->add_control( 'elc_top_page_facebook_url', array(
    ...
    'label'		=> __( 'Footer Facebook URL', 'luxeritas' ),
    'description'	=> '<p class="f09em">' . __( '', 'luxeritas' ) . '</p>',
    'section'	=> 'top_page_section',
    'type'		=> 'text',
    'priority'	=> 100
  ...
  $wp_customize->add_control( 'elc_top_page_twitter_url', array(
    ...
    'label'		=> __( 'Footer Twitter URL', 'luxeritas' ),
    'description'	=> '<p class="f09em">' . __( '', 'luxeritas' ) . '</p>',
    'section'	=> 'top_page_section',
    'type'		=> 'text',
    'priority'	=> 100
      ...
      $wp_customize->add_control( 'elc_top_page_instagram_url', array(
          ...
          'label'		=> __( 'Footer Instagram URL', 'luxeritas' ),
          'description'	=> '<p class="f09em">' . __( '', 'luxeritas' ) . '</p>',
          'section'	=> 'top_page_section',
          'type'		=> 'text',
          'priority'	=> 100
  ...
  // NEWSページ
  //---------------------------------------------------------------------------
  if($wp_customize->get_section( 'news_page_section')===false):
  $wp_customize->add_section( 'news_page_section', array(
    'title'		=> __( 'News page setting', 'luxeritas' ),
  ...
  //NEWS表示件数	number
  $wp_customize->add_setting( 'elc_news_page_news_count', array(
    'default'	=> 10,
    'type'      => 'option',
    'transport' => 'postMessage',
    'sanitize_callback' => 'thk_sanitize_integer'
  ) );
  $wp_customize->add_control( 'elc_news_page_news_count', array(
    'settings'	=> 'elc_news_page_news_count',
    'description'	=> '<p class="m0t">' . __( 'News count', 'luxeritas' ) . '</p>',
    'section'	=> 'news_page_section',
    'type'		=> 'number',
    'priority'	=> 50
  ...
  // Call to Actionの表示有無
  $wp_customize->add_setting( 'elc_news_page_news_contact', array(
    'default'	=> true,
    'sanitize_callback' => 'thk_sanitize_boolean'
  ) );
  $wp_customize->add_control( 'elc_news_page_news_contact', array(
    'settings'	=> 'elc_news_page_news_contact',
    'label'		=> __( 'Call to Action ', 'luxeritas' ),
    'section'	=> 'news_page_section',
    'type'		=> 'checkbox',
    'priority'	=> 55
  ) );
...
*/
	...
	$wp_customize->add_control( 'head_img_vertical', array(
		...
		'description'	=> __( '* display area of ​​the image , please adjust the width and height in the &quot;header padding adjustment&quot; of &quot;the entire layout&quot;.', 'luxeritas' ) . '<br />' . __( '* Please check the look in mobile phones by yourself :-)', 'luxeritas' ),
		'section'	=> 'img_section',
		'type'		=> 'select',
		'choices'	=> array(
			'top'		=> 'Top',
